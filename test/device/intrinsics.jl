...
shuffle_types = [Float32, Float16, Int32, UInt32, Int16, UInt16, Int8, UInt8]
metal_support() >= v"3.1" && push!(shuffle_types, BFloat16)
@testset "$f($typ)" for typ in shuffle_types, (f,res_idx) in [(simd_shuffle_down, 1), (simd_shuffle_up, 32)]
