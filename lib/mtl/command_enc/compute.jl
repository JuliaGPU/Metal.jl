...
function MTLComputeCommandEncoder(
    ...
    return MTLComputeCommandEncoder(handle)
end

function set_function!(cce::MTLComputeCommandEncoder, pip::MTLComputePipelineState)
    return @objc [cce::id{MTLComputeCommandEncoder} setComputePipelineState:pip::id{MTLComputePipelineState}]::Nothing
end

function set_buffer!(cce::MTLComputeCommandEncoder, buf::MTLBuffer, offset, index)
    return @objc [
        cce::id{MTLComputeCommandEncoder} setBuffer:buf::id{MTLBuffer}
        offset:offset::NSUInteger
        atIndex:(index - 1)::NSUInteger
    ]::Nothing
end

function dispatchThreadgroups!(cce::MTLComputeCommandEncoder, gridSize, threadGroupSize)
    return @objc [
        cce::id{MTLComputeCommandEncoder} dispatchThreadgroups:gridSize::MTLSize
        threadsPerThreadgroup:threadGroupSize::MTLSize
    ]::Nothing
end
...
function append_current_function!(cce::MTLComputeCommandEncoder, gridSize, threadGroupSize)
    return dispatchThreadgroups!(cce, gridSize, threadGroupSize)
end
...
function use!(cce::MTLComputeCommandEncoder, buf::MTLBuffer, mode::MTLResourceUsage = ReadWriteUsage)
    return @objc [
        cce::id{MTLComputeCommandEncoder} useResource:buf::id{MTLBuffer}
...
function use!(cce::MTLComputeCommandEncoder, buf::Vector{MTLBuffer}, mode::MTLResourceUsage = ReadWriteUsage)
    return @objc [
        cce::id{MTLComputeCommandEncoder} useResources:buf::id{MTLBuffer}
